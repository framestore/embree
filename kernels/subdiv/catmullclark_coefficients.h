...
namespace embree
{
  ...
  static const size_t MAX_RING_FACE_VALENCE = 128;     //!< maximum number of faces per ring
  static const size_t MAX_RING_EDGE_VALENCE = 2*128;   //!< maximum number of edges per ring
